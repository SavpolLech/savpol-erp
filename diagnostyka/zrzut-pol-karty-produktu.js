...
// zakładkę i wkleisz skrypt jeszcze raz, dostaniesz jej zawartość — bez
// względu na to, czy to górny przełącznik (Dane podstawowe/dodatkowe) czy
// boczna lista (Zapasy/Zdjęcia/Grupy/...).
//
// Jak używać:
//   1. Otwórz w ERP KARTĘ PRODUKTU (Edycja) dowolnego produktu.
//   2. Kliknij zakładkę, którą chcesz zebrać (np. "Dane podstawowe").
//   3. Wklej ten plik w konsolę.
//   4. Wynik sam ląduje w schowku. Wklej go do rozmowy.
//   5. Powtórz dla kolejnej zakładki — każdy zrzut to osobna wklejka.
//
...
(function () {
  ...
  if (!karta) {
    ...
    // Nagłówki grup na aktywnej zakładce — pomaga zorientować się w sekcjach,
    // gdy etykieta pola sama w sobie nic nie mówi.
    linie.push('');
