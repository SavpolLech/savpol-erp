@echo off
REM ============================================================
REM  Automatyzacja MM / przesuniecia magazynowe (Savpol) -
REM  PIERWSZA INSTALACJA na serwerze. Odpalasz to RAZ (dwuklik).
REM  Zero znajomosci GitHuba potrzebne.
REM
REM  ZANIM ODPALISZ: na tym komputerze musi byc zainstalowane
REM    1) Node.js (LTS)  - https://nodejs.org
...
REM
REM  UWAGA: jesli na tym serwerze dziala juz automatyzacja WZ, kod jest
REM  w TYM SAMYM repo (folder %INSTALL_DIR%) - wtedy nie klonujesz drugi
REM  raz, tylko rejestrujesz osobne zadanie w Harmonogramie wskazujace na
REM  serwer\uruchom.bat z folderu automatyzacje\mm.
REM ============================================================
...
if exist "%INSTALL_DIR%" (
  ...
  git clone --branch mm-deploy "%REPO_URL%" "%INSTALL_DIR%"
  if errorlevel 1 (
...
cd "%INSTALL_DIR%\automatyzacje\mm"
...
echo  1) Otworz plik:
echo       %INSTALL_DIR%\automatyzacje\mm\.env
...
echo       %INSTALL_DIR%\automatyzacje\mm\serwer\uruchom.bat
echo     - szczegolowa instrukcja krok po kroku jest w pliku:
echo       %INSTALL_DIR%\automatyzacje\mm\serwer\INSTRUKCJA-TOMEK.md
echo ============================================================
pause
