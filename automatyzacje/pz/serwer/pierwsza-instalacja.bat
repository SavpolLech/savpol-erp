...
REM
REM  UWAGA: jesli na tym serwerze dziala juz automatyzacja WZ/MM, kod jest
...
REM  serwer\uruchom.bat z folderu automatyzacje\pz.
REM ============================================================
...
if exist "%INSTALL_DIR%" (
  ...
  git clone --branch pz-deploy "%REPO_URL%" "%INSTALL_DIR%"
  if errorlevel 1 (
...
cd "%INSTALL_DIR%\automatyzacje\pz"
...
echo  1) Otworz plik:
echo       %INSTALL_DIR%\automatyzacje\pz\.env
...
echo       %INSTALL_DIR%\automatyzacje\pz\serwer\uruchom.bat
echo     - szczegolowa instrukcja krok po kroku jest w pliku:
echo       %INSTALL_DIR%\automatyzacje\pz\serwer\INSTRUKCJA-TOMEK.md
echo ============================================================
pause
