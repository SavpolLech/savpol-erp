...
// WSZYSTKIE jego dokumenty do bazy (nie tylko jeden testowy). Dokłada te
// same stałe wartości co scrape.js (lib/fixed-values.js) i ma tę samą
// ochronę przed duplikatem (sprawdza csDocsHeadersId w bazie przed
// insertem, jednym zapytaniem dla całej paczki).
//
// Uruchomienie: node import-csv-to-db.js 2026-07-01
...
async function main() {
  ...
  if (!dateArg) throw new Error('Podaj datę: node import-csv-to-db.js 2026-07-01');
  ...
  positions.forEach(p => Object.assign(p, POSITION_FIXED_VALUES));
